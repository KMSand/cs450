...
emails = [
    "Final Reminder: Submit your travel reimbursement by tonight.",
    "New security policy goes into effect Monday — here's what changes.",
    "We're thrilled to invite you to our beta testing program!",
    "Don't miss out: Early bird tickets are selling fast!",
    "Can we count on your feedback? Quick 2-minute survey inside."
]
