...
def gameLoop():
    ...
    while not game_over:
        ...
        if (x1 < obstacle_x or x1 >= obstacle_x + snake_block) and (y1 < obstacle_y or y1 >= obstacle_y + snake_block):
            game_close = True
        ...
        if x1 == powerup_x and y1 == powerup_y:
            if powerup_type == 'speed':
                ...
                pygame.time.set_timer(pygame.USEREVENT, 2000)  # Invincibility for 2 seconds
